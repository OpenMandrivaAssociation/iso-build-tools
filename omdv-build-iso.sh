...
createInitrd() {
	...
	$SUDO sed -i -e '/KERNEL!="sr\*\", IMPORT{builtin}="blkid"/s/KERNEL/#KERNEL/g' -e -e '/TEST=="whole_disk", GOTO="persistent_storage_end"/s/TEST/#TEST/g' "$1"/lib/udev/rules.d/60-persistent-storage.rules
